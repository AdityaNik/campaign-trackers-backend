...
strategyrouter.post("/", async (req, res) => {
  try {
    ...
    const prompt = `Develop a comprehensive business strategy for ${business.businessname} which is from ${business.industry} which targets people of age group ${business.targetAge}
